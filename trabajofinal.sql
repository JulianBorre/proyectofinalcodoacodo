...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-01-2023 a las 00:48:48
...
`idlocalidad` int(11) NOT NULL,
  `nombrelocalidad` varchar(40) COLLATE latin1_spanish_ci NOT NULL,
...
`idpedido` int(11) NOT NULL,
  ...
  `lugarentrega` varchar(30) COLLATE latin1_spanish_ci NOT NULL,
  `localidad` int(11) NOT NULL,
  `provincia` int(11) NOT NULL,
  `codpostal` varchar(80) COLLATE latin1_spanish_ci NOT NULL,
  `formadepago` varchar(1) COLLATE latin1_spanish_ci NOT NULL,
  `tarjtitutal` varchar(40) COLLATE latin1_spanish_ci NOT NULL,
  `tarjnumero` int(16) NOT NULL,
  `tarjvto` varchar(10) COLLATE latin1_spanish_ci NOT NULL,
...
`idusuario` int(11) NOT NULL,
  ...
  `nombreyapellido` varchar(40) COLLATE latin1_spanish_ci NOT NULL
...
(1, 'prueba@gmail.com', '909090', 'Julián Horacio Borré'),
(4, 'miemail@gmail.com', 'holaholahola', 'Usuario Prueba');
